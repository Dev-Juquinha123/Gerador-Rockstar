...
int main(int argc, char** argv)
{
	...
	cout << left; cout.width(20); cout << "-------";  cout << right; cout.width(6); cout << "-----"; cout.width(8); cout << "-----" << endl;
	cout << left; cout.width(20); cout << "Abacaxi";  cout << right; cout.width(6); cout << "2.5";   cout.width(8); cout << "1.99" << endl;
	...
	cout << left; cout.width(20); cout << "Goiaba";   cout << right; cout.width(6); cout << "20.5";  cout.width(8); cout << "56.00" << endl;
